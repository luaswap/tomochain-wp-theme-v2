            ...
            <div class="tmc-roadmap-head">
              <ul class="tmc-roadmap-filter">
                <li class="selected">
                  ...
                  <div class="tmc-desc"><?php echo $desc;?></div>
                </li>
                <?php
                if(!empty($cats)):
                  if($cats){
                    ...
                    ?>
                      <li>
                        <a href="#" data-filter="<?php echo esc_attr($rm->term_id)?>"><?php echo esc_html($rm->name);?>
                         
                        </a>
                        <div class="tmc-desc"><?php echo term_description($rm->term_id);?></div>
                      </li>
                  <?php
                    }
                  }
