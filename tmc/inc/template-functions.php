...
if(!function_exists('tmc_change_term_request')):
    add_filter('request', 'tmc_change_term_request', 1, 1 );
     
    function tmc_change_term_request($query){
...
if(!function_exists('tmc_term_permalink')):
    add_filter( 'term_link', 'tmc_term_permalink', 10, 3 );
     
    function tmc_term_permalink( $url, $term, $taxonomy ){
        $taxonomy_name = 'publication_cat'; // your taxonomy name here
        $taxonomy_slug = 'publication_cat'; // the taxonomy slug can be different with the taxonomy name (like 'post_tag' and 'tag' )
...
if(!function_exists('tmc_old_term_redirect')):
    add_action('template_redirect', 'tmc_old_term_redirect');
     
    function tmc_old_term_redirect() {
     
        $taxonomy_name = 'publication_cat';
        $taxonomy_slug = 'publication_cat';
